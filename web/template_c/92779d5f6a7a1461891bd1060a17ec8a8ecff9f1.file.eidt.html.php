<?php /* Smarty version Smarty-3.1.16, created on 2015-08-07 13:18:09
         compiled from "tpl/Admin/eidt.html" */ ?>
<?php /*%%SmartyHeaderCode:56765579755c43c225dc3e8-87569126%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '92779d5f6a7a1461891bd1060a17ec8a8ecff9f1' => 
    array (
      0 => 'tpl/Admin/eidt.html',
      1 => 1438924690,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '56765579755c43c225dc3e8-87569126',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_55c43c2261ab58_56059095',
  'variables' => 
  array (
    'arc' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_55c43c2261ab58_56059095')) {function content_55c43c2261ab58_56059095($_smarty_tpl) {?><!doctype html>
...
<head>
	...
	<script type="text/javascript" src="/pub/edit/third-party/SyntaxHighlighter/shCore.js"></script>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
											...
											<form action="" method="post">
                                                <header class="panel-heading">博文<button type="submit" class="btn btn-success btn-outline" style="margin-left:50px;">提交保存</button></header>
                                                ...
                                                <div class="panel-body">
                                                    <div class="form-horizontal bordered-group" role="form">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" name="title" value="<?php echo $_smarty_tpl->tpl_vars['arc']->value[0]['title'];?>
">
                                                            </div>
                                                        </div>
														...
														<div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
															      <textarea   class="form-control" contenteditable="true"  name="dsc" style="height:100px;"><?php echo $_smarty_tpl->tpl_vars['arc']->value[0]['dsc'];?>
</textarea>
                                                        ...
                                                        <div class="form-group" action="" method="post">
															...
															<textarea id="kkeditor"  class="form-control" contenteditable="true"  name="content" style="height:500px;width:100%;"><?php echo $_smarty_tpl->tpl_vars['arc']->value[0]['content'];?>
</textarea>
                                                            </div>  
